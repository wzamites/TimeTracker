...
$( ".block" ).draggable({
    cursor: "grabbing",
    helper: function() {return $( this ).clone().appendTo( "#body" ).addClass("draggingblock").removeClass("block");},
    scroll: true,
    scrollSensitivity: 1,
    ...
    drag: function(){
        var offsetdrag = $(".draggingblock").offset();
        var offsetrow = $(".calendardrop").offset();
